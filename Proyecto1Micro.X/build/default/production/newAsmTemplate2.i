...
Inicio:
    ...
    BSF INTCON2, 4, a ; ((PORTB) and 0FFh), 2, a SE ACTIVA ((RCON) and 0FFh), 1, a FLANCO DE BAJADA (1 A 0, BOTON A GND)
...
Loop_Principal:
    ...
    ; APAGAR AMBOS DISPLAYS ANTES DE CAMBIAR DE NUMERO
...
;===============================================
RETARDO_MUX:
    MOVLW 10 ; SE CARGA EL MULTIPLICADOR PRINCIPAL
    MOVWF DELAY1, a ; CARGAR EL VALOR DEL DELAY1
LOOP_M1:
    MOVLW 166 ;SEGUNDO MULTIPLICADOR
    MOVWF DELAY2, a ;CARGA EL VALOR DE DELAY2
LOOP_M2:
