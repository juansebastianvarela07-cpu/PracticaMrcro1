# 1 "Practica1_ControlTemperatura.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Practica1_ControlTemperatura.s" 2
;========================================================================
...
# 9 "Practica1_ControlTemperatura.s" 2
...
Inicio:
    ...
    BCF TRISC, 0, a ; ((PORTC) and 0FFh), 0, a (PIN 15) SALIDA DE TRANSISTOR DECENAAS
    BCF TRISC, 1, a ; ((PORTC) and 0FFh), 1, a (PIN 16 SALIDA PARA TRANSISTOR UNIDADES
    CLRF LATC, a
